                        ...
                        <Link href={`/games/${game.slug}`} key={i}>
                          ...
                          >
                            <div className="relative aspect-[4/3] mt-1">
                              ...
                              />
                              <div className="absolute inset-x-0 -bottom-8 top-0 bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end pb-6">
                                <MotionButton
