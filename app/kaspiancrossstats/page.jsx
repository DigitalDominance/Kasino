...
export default function KaspianCrossStatsPage() {
  ...
  // Filter out the game data for "Kaspian Cross"
  const kaspianCrossGame = statsData?.games?.find(
    ...
    >
      ...
      <main className="p-6">
        ...
        {loading ? (
          ...
          // Single large card for Kaspian Cross
          <motion.div
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300">
                ...
                <span className="text-[#49EACB]">
                  <CountUp
                    end={kaspianCrossGame.totalWinAmount}
                    duration={1.5}
                    separator=","
                    decimals={2}
                  />
