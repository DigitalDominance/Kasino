          ...
          {visibleTiles.map((tile) => {
            ...
            return (
              ...
              >
                ...
                {/* Tile image */}
                <div className="relative w-full h-full cursor-pointer" onClick={isActive ? onTileClick : undefined}>
                  <Image
                    src={TILE}
                    alt="Tile"
                    fill
...
function KaspianCrossContent() {
  ...
  // Generate decorative kasps with random positions
