      ...
      <main className="flex-grow p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="order-2 lg:order-1">
            {/* Desktop: use a fixed-height flex container */}
            <div className="hidden lg:flex flex-col gap-6 h-[90vh]">
              {/* Project Collaboration Card */}
              <Card className="bg-[#49EACB]/5 border border-[#49EACB]/10 backdrop-blur-sm flex-1 p-6">
                <motion.h2
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(270deg, #8B0000, #000000, #8B0000)",
                ...
                <p className="text-sm text-white mb-4">
                  This game is a collaborative effort with KASEN, a pioneer in
                  digital gaming. Their creative vision and innovative approach
                  have redefined our casino experience. Learn more about their
                  work through the links below.
                </p>
            ...
            <div className="lg:hidden space-y-6">
              {/* Project Collaboration Card */}
              <Card className="bg-[#49EACB]/5 border border-[#49EACB]/10 backdrop-blur-sm p-6">
                <motion.h2
                  className="text-2xl font-bold mb-4 text-transparent bg-clip-text"
                  animate={{ backgroundPosition: ["0% 50%", "100% 50%"] }}
                  transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
