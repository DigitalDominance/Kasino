      ...
      <main className="flex-grow p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="order-2 lg:order-1 space-y-6">
            {/* KASEN Collaboration Card */}
            <Card className="bg-[#49EACB]/5 border border-[#49EACB]/10 backdrop-blur-sm p-6 flex flex-col items-center text-center h-full">
              <motion.h2
          ...
          <div className="order-1 lg:order-2">
            <Card className="bg-[#49EACB]/5 border border-[#49EACB]/10 backdrop-blur-sm overflow-hidden">
              {/* Make the game container the same height as the left column combined on desktop */}
