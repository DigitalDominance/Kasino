...
import { XPDisplay } from "@/app/page" // Assuming this is exported from the main page
...
function MultiplayerGamesContent() {
  ...
  const multiplayerGames: MultiplayerGame[] = [
    ...
    },
    {
      ...
      image: "/placeholder.svg?key=zvn25",
      players: 156,
      activeTables: 28,
    ...
    },
    {
      name: "Dice Duel",
      slug: "dice-duel",
      image: "/placeholder.svg?key=u7cgi",
      players: 89,
      activeTables: 15,
    ...
    },
    {
      name: "Kaspa Chess",
      slug: "kaspa-chess",
      image: "/placeholder.svg?key=8z51a",
      players: 67,
      activeTables: 22,
    ...
    },
    {
      ...
      image: "/placeholder.svg?key=ckpww",
      players: 312,
      activeTables: 8,
    ...
    },
    {
      ...
      image: "/placeholder.svg?key=ji5cx",
      players: 78,
      activeTables: 12,
      ...
      <AnimatePresence mode="wait">
        {!isLoading && (
          ...
          >
            ...
            {/* Header */}
            <header className="flex flex-wrap items-center justify-between p-2 sm:p-4 border-b border-[#49EACB]/10 backdrop-blur-sm sticky top-0 z-50">
              <motion.div
                ...
                <div className="container-xl">
                    ...
                    <div className="relative w-full h-full overflow-hidden rounded-lg border border-[#49EACB]/10">
                      {multiplayerBanners.map((banner, index) => (
                        ...
                        >
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent flex flex-col justify-center items-center text-center p-8 md:p-12">
                            <motion.h1
                  ...
                  >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
                      ...
                      <div className="flex items-center justify-center md:justify-start gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-200">Games Played Today</p>
                      ...
                      <div className="flex items-center justify-center md:justify-start gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-200">Total KAS Won</p>
                  ...
                  >
                    <div className="flex flex-wrap gap-2 justify-center max-w-4xl mx-auto">
                      <Button
                        ...
                        className={`category-pill text-xs sm:text-sm md:text-base ${activeCategory === null ? "active" : "bg-gray-800 text-white hover:bg-gray-700"}`}
                      >
                        All Games
                      </Button>
                      <Button
                        onClick={() => setActiveCategory("card")}
                        className={`category-pill text-xs sm:text-sm md:text-base ${activeCategory === "card" ? "active" : "bg-gray-800 text-white hover:bg-gray-700"}`}
                      >
                        <GiPokerHand className="mr-1 md:mr-2" /> <span className="hidden xs:inline">Card</span> Games
                      </Button>
                      <Button
                        onClick={() => setActiveCategory("dice")}
                        className={`category-pill text-xs sm:text-sm md:text-base ${activeCategory === "dice" ? "active" : "bg-gray-800 text-white hover:bg-gray-700"}`}
                      >
                        <FaDice className="mr-1 md:mr-2" /> <span className="hidden xs:inline">Dice</span> Games
                      </Button>
                      <Button
                        onClick={() => setActiveCategory("strategy")}
                        className={`category-pill text-xs sm:text-sm md:text-base ${activeCategory === "strategy" ? "active" : "bg-gray-800 text-white hover:bg-gray-700"}`}
                      >
                        <FaChess className="mr-1 md:mr-2" /> <span className="hidden xs:inline">Strategy</span> Games
                      </Button>
                      <Button
                        onClick={() => setActiveCategory("tournament")}
                        className={`category-pill text-xs sm:text-sm md:text-base ${activeCategory === "tournament" ? "active" : "bg-gray-800 text-white hover:bg-gray-700"}`}
                      >
                        <Trophy className="mr-1 md:mr-2" /> <span className="hidden xs:inline">Tournaments</span>
                      </Button>
                    </div>
                  </motion.div>
                      ...
                      {featuredGames.map((game, i) => (
                        ...
                        >
                          <Link href={`/games/${game.slug}`}>
                            <MotionCard className="overflow-hidden border border-[#49EACB] bg-black h-full glow-effect">
                        ...
                        >
                          <Link href={`/games/${game.slug}`}>
                            <MotionCard
                              ...
                              whileHover={{
                                scale: 1.05,
                                boxShadow: "0 0 30px rgba(73, 234, 203, 0.5)",
                              }}
                              transition={{ duration: 0.3 }}
                            >
                  ...
                  >
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 flex items-center hover-effect transition-all duration-500">
                      ...
                      <span className="animate-gradient">Ready to Join</span>
                    </h2>
                            ...
                            >
                              ...
                              <div className="p-4">
                                ...
                                <div className="text-sm text-gray-400">
                                  {match.players.length} Players • Table {i + 1}
                                </div>
                                <Button
                                  className="w-full mt-2 bg-[#49EACB] hover:bg-[#49EACB]/80 text-black font-semibold"
                                  size="sm"
                                >
                                  Join Match
                                </Button>
                    ...
                    <div className="relative overflow-hidden rounded-lg border border-[#49EACB]/20 bg-gradient-to-r from-[#003f2f] to-[#006d5b] p-6 md:p-8">
                      ...
                      <div className="relative z-10 max-w-3xl">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-white">
                          Join Our Multiplayer Community
                        </h2>
                        <p className="text-gray-200 mb-6">
                          Connect with players, join tournaments, and stay updated on the latest multiplayer events.
                          Join our Telegram group to chat with other players and get exclusive access to private
                          tournaments.
                        </p>
